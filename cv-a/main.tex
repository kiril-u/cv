...
\begin{document}
	...
	\hspace{.25\textwidth}
\begin{minipage}[t]{.5\textwidth}
	\par{\centering{\Huge  \bfseries{קיריל אוריבסקי}}\par}
\end{minipage}
\section{מידע}
...
\begin{minipage}[t]{.5\linewidth}
	\begin{tabular}{rl}
		...
		\location{} : &\href{https://goo.gl/maps/MSacjpSy7vZSKykP7}{אשדוד, מחוז דרום}
	\end{tabular}
\end{minipage}	
\section{השכלה}
\entry{2019}
...
{כחלק מהכשרתי לקחתי חלק בהתנסות מעשית (פרקטיקום) אשר במהלכה השתתפתי בישיבות ייעוץ עם סגל ההוראה וחברי צוות ההנהלה של בית ספר תיכון וגן חינוך מיוחד בעפולה, וכמו כן ביצעתי ההערכות פסיכודיאגנוסטיות ופסיכודידקטיות עבור תלמידים שהופנו אל השירות הפסיכולוגי, וקיימתי פגישות הדרכת עם הוריהם של חלקם.
	...
	\href{https://tinyurl.com/ADHD-Coping-Seminar}{ד"ר דן אורי}
	אודות השפעותיהן של הפרעות קשב והיפראקטיביות ולקויות למידה לאורך חייהם ועל פני מספר תחומי תפקוד התפתחותי.}
{}
\entry{2015--2018}
{תואר ראשון בפסיכולוגיה ובלימודים רב תחומיים במדעי הרוח והחברה. סיום התואר \textbf{בהצטיינות יתרה}, ממוצע ציונים: 95.00.}
{בעל תעודת הצטיינות (2017) ותעודת הצטיינות רקטור (2018) עבור הישגיי הלימודיים.}
{לימודיי הרב תחומיים במדעי הרוח והחברה כללו את החטיבות לפילוסופיה ולניהול ויישוב סכסוכים ומו"מ}   
\subsection{הכשרות נוספות}
\entry{2009--2010}
{סיום קורס \textbf{טכנאי מחשבים}, IQline, האקדמיה למדע ואומנות}
...
\entry{Human}
   {% xelatex
   	...
   	\begin{document}
   		...
   		\section{שפות}
   		\entry{אנושיות}
   		{\textbf{בעל שליטה גבוהה בשפה האנגלית, בעברית, וברוסית.}}
   		{}
   		{}
   		\entry{מחשב}
   		{}
   		...
   		{}
   		\entry{2015--2018}
   		{\textbf{חונך אישי} עבור ילדים ונערים בסיכון במסגרת פרוייקט פר"ח}
   		{}
   		{}		
   		\unsetRTL
   		\pagebreak 
...
\section{Languages}
	\entry{Human}
        ...
        {}
	\entry{Machine}
		{bash and similar shell scripts}
		{A myriad of markup languages including LaTeX/XeTeX, Markdown, XML, and HTML.}
