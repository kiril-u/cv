...
\newcommand{\bgu}{Ben-Gurion University}
\newcommand{\yvc}{Yezreel Valley College}

\let\lineheight\baselineskip

% Link images
\newcommand{\pdf}{\includegraphics[height=.85em]{ico/pdf.png}}
\newcommand{\li}{\includegraphics[height=.85em]{ico/li.png}} 
...
\begin{tabular}{rp{.75\linewidth}}
	...
	\email{} :     & \href{mailto:kirilurivsky@gmail.com}{kirilurivsky@gmail.com}\\
        \www{} : &\href{https://www.kirilu.xyz}{https://kirilu.xyz}\\
	\li{} : &\href{https://www.linkedin.com/in/kiril-u}{https://linkedin.com/in/kiril-u}\\
...
\section{Prior Workplace Experience}
...
\entry{Machine}
	{Bash/shell, some superficial knowledge of C, Java and Javascript; markup languages including {\LaTeX}/{\XeTeX}, and HTML.}
	{}

\section{Skills and Tools I Use}
